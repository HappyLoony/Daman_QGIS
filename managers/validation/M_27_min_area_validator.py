...
Используется в:
- F_2_1 (после нарезки)
- F_2_3 (после корректировки)
- F_2_4 (после стейджинга)
"""
...
class MinAreaValidator:
    ...
    ZPR_TYPE_TO_CUTTING_LAYERS = {
        'ОКС': [
            'Le_2_1_1_1_Раздел_ЗПР_ОКС',
            'Le_2_1_1_2_НГС_ЗПР_ОКС',
            'Le_2_1_1_3_Без_Меж_ЗПР_ОКС',
            'Le_2_1_1_4_ПС_ЗПР_ОКС',
        ],
        'ПО': [
            'Le_2_1_2_1_Раздел_ЗПР_ПО',
            'Le_2_1_2_2_НГС_ЗПР_ПО',
            'Le_2_1_2_3_Без_Меж_ЗПР_ПО',
            'Le_2_1_2_4_ПС_ЗПР_ПО',
        ],
        'ВО': [
            'Le_2_1_3_1_Раздел_ЗПР_ВО',
            'Le_2_1_3_2_НГС_ЗПР_ВО',
            'Le_2_1_3_3_Без_Меж_ЗПР_ВО',
            'Le_2_1_3_4_ПС_ЗПР_ВО',
        ],
        'РЕК_АД': [
            'Le_2_2_1_1_Раздел_ЗПР_РЕК_АД',
            'Le_2_2_1_2_НГС_ЗПР_РЕК_АД',
            'Le_2_2_1_3_Без_Меж_ЗПР_РЕК_АД',
            'Le_2_2_1_4_ПС_ЗПР_РЕК_АД',
        ],
        'СЕТИ_ПО': [
            'Le_2_2_2_1_Раздел_ЗПР_СЕТИ_ПО',
            'Le_2_2_2_2_НГС_ЗПР_СЕТИ_ПО',
            'Le_2_2_2_3_Без_Меж_ЗПР_СЕТИ_ПО',
            'Le_2_2_2_4_ПС_ЗПР_СЕТИ_ПО',
        ],
        'СЕТИ_ВО': [
            'Le_2_2_3_1_Раздел_ЗПР_СЕТИ_ВО',
            'Le_2_2_3_2_НГС_ЗПР_СЕТИ_ВО',
            'Le_2_2_3_3_Без_Меж_ЗПР_СЕТИ_ВО',
            'Le_2_2_3_4_ПС_ЗПР_СЕТИ_ВО',
        ],
        'НЭ': [
            'Le_2_2_4_1_Раздел_ЗПР_НЭ',
            'Le_2_2_4_2_НГС_ЗПР_НЭ',
            'Le_2_2_4_3_Без_Меж_ЗПР_НЭ',
