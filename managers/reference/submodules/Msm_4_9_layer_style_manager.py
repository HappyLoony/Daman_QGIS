...
class LayerStyleManager:
    ...
    def get_layer_autocad_style(self, full_name: str) -> Optional[Dict]:
        ...
        line_color_RGB = layer.get('line_color_RGB', '255,255,255')
        line_global_weight = layer.get('line_global_weight', 1)
        line_transparency = layer.get('line_transparency', 0)

        hatch_color_RGB = layer.get('hatch_color_RGB', '255,255,255')
        hatch_global_lineweight = layer.get('hatch_global_lineweight', 0.7)
        ...
        return {
            ...
            'not_print': layer.get('not_print', 0)
        }
