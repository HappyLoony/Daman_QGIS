# -*- coding: utf-8 -*-
"""Менеджер правил классификации негативных процессов (автоматическое распределение по слоям)"""

from typing import List, Dict, Optional, Union
from Daman_QGIS.database.base_reference_loader import BaseReferenceLoader


class NegativClassificationManager(BaseReferenceLoader):
    """Менеджер для работы с правилами классификации негативных процессов из Base_negativ_classification.json"""

    FILE_NAME = 'Base_negativ_classification.json'

    def get_rules(self) -> List[Dict]:
        """
        Получить список правил классификации негативных процессов
    ...
    def validate_rules(self) -> Dict[str, Union[List, int]]:
        """
        Валидация правил классификации негативных процессов
    ...
    def get_classification_info(self) -> Dict:
        """
        Получить информацию о базе правил классификации негативных процессов
        ...
        return {
            ...
            'source': 'Base_negativ_classification.json',
            'description': 'Правила автоматической классификации негативных процессов по ключевым словам'
        }
