...
# Реэкспорт для использования: from Daman_QGIS.managers import BaseAsyncTask
__all__ = ['AsyncTaskManager', 'BaseAsyncTask', 'MessageBarReporter', 'SilentReporter']
...
class AsyncTaskManager:
    ...
    def __init__(self, iface=None):
        ...
        Args:
            iface: QgisInterface (опционально, получается из qgis.utils если не передан)
        """
        if iface is None:
