...
from Daman_QGIS.constants import API_BASE_URL, API_TIMEOUT, DEFAULT_MAX_RETRIES, DEFAULT_RETRY_DELAY
...
class RequestHandler:
    ...
    RETRY_DELAY = DEFAULT_RETRY_DELAY  # Используется из constants.py (секунды)
