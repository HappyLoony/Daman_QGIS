...
UI-точка входа:
    F_2_1 (единственная кнопка) -> cut_all() -> все типы ЗПР

Типы ЗПР:
    Стандартные (L_1_12_*):
        - ОКС: L_1_12_1_ЗПР_ОКС -> Le_2_1_1_*
        - ПО:  L_1_12_2_ЗПР_ПО  -> Le_2_1_2_*
        - ВО:  L_1_12_3_ЗПР_ВО  -> Le_2_1_3_*

    Линейные (L_1_13_*):
        - РЕК_АД:   L_1_13_1_ЗПР_РЕК_АД   -> Le_2_2_1_*
        - СЕТИ_ПО:  L_1_13_2_ЗПР_СЕТИ_ПО  -> Le_2_2_2_*
        - СЕТИ_ВО:  L_1_13_3_ЗПР_СЕТИ_ВО  -> Le_2_2_3_*
        - НЭ:       L_1_13_4_ЗПР_НЭ       -> Le_2_2_4_*

    Будущее:
        - Лесные выделы (планируется)

API:
    - cut_all() - нарезка ВСЕХ типов (вызывается из F_2_1)
...
from Daman_QGIS.constants import (
    ...
    # Overlay слои
    LAYER_SELECTION_NP, LAYER_SELECTION_MO, LAYER_EGRN_LES, LAYER_WFS_OOPT, LAYER_SELECTION_VODA,
    ...
    # Слои Изм и Без_Меж
    LAYER_CUTTING_OKS_IZM, LAYER_CUTTING_OKS_BEZ_MEZH,
    LAYER_CUTTING_PO_IZM, LAYER_CUTTING_PO_BEZ_MEZH,
    LAYER_CUTTING_VO_IZM, LAYER_CUTTING_VO_BEZ_MEZH,
)
# Lazy imports для избежания циклических зависимостей
# registry, LayerSchemaValidator импортируются внутри методов

if TYPE_CHECKING:
    from Daman_QGIS.managers import LayerManager

__all__ = ['CuttingManager']
...
class CuttingManager:
    ...
    # Конфигурация стандартных ЗПР (F_2_1)
    ZPR_CONFIG = {
        'ОКС': {
            'source': LAYER_ZPR_OKS,
            'razdel': LAYER_CUTTING_OKS_RAZDEL,
            'ngs': LAYER_CUTTING_OKS_NGS,
            'izm': LAYER_CUTTING_OKS_IZM,
            'bez_mezh': LAYER_CUTTING_OKS_BEZ_MEZH,
            'points_razdel': 'Le_2_5_1_1_Т_Раздел_ЗПР_ОКС',
            'points_ngs': 'Le_2_5_1_2_Т_НГС_ЗПР_ОКС',
        },
        'ПО': {
            'source': LAYER_ZPR_PO,
            'razdel': LAYER_CUTTING_PO_RAZDEL,
            'ngs': LAYER_CUTTING_PO_NGS,
            'izm': LAYER_CUTTING_PO_IZM,
            'bez_mezh': LAYER_CUTTING_PO_BEZ_MEZH,
            'points_razdel': 'Le_2_5_2_1_Т_Раздел_ЗПР_ПО',
            'points_ngs': 'Le_2_5_2_2_Т_НГС_ЗПР_ПО',
        },
        'ВО': {
            'source': LAYER_ZPR_VO,
            'razdel': LAYER_CUTTING_VO_RAZDEL,
            'ngs': LAYER_CUTTING_VO_NGS,
            'izm': LAYER_CUTTING_VO_IZM,
            'bez_mezh': LAYER_CUTTING_VO_BEZ_MEZH,
            'points_razdel': 'Le_2_5_3_1_Т_Раздел_ЗПР_ВО',
            'points_ngs': 'Le_2_5_3_2_Т_НГС_ЗПР_ВО',
        },
    }

    # Конфигурация рекреационных ЗПР_РЕК (F_2_2)
    ZPR_REK_CONFIG = {
        'РЕК_АД': {
            'source': LAYER_ZPR_REK_AD,
            'razdel': 'Le_2_2_1_1_Раздел_ЗПР_РЕК_АД',
            'ngs': 'Le_2_2_1_2_НГС_ЗПР_РЕК_АД',
            'points_razdel': 'Le_2_6_1_1_Т_Раздел_ЗПР_РЕК_АД',
            'points_ngs': 'Le_2_6_1_2_Т_НГС_ЗПР_РЕК_АД',
        },
        'СЕТИ_ПО': {
            'source': LAYER_ZPR_SETI_PO,
            'razdel': 'Le_2_2_2_1_Раздел_ЗПР_СЕТИ_ПО',
            'ngs': 'Le_2_2_2_2_НГС_ЗПР_СЕТИ_ПО',
            'points_razdel': 'Le_2_6_2_1_Т_Раздел_ЗПР_СЕТИ_ПО',
            'points_ngs': 'Le_2_6_2_2_Т_НГС_ЗПР_СЕТИ_ПО',
        },
        'СЕТИ_ВО': {
            'source': LAYER_ZPR_SETI_VO,
            'razdel': 'Le_2_2_3_1_Раздел_ЗПР_СЕТИ_ВО',
            'ngs': 'Le_2_2_3_2_НГС_ЗПР_СЕТИ_ВО',
            'points_razdel': 'Le_2_6_3_1_Т_Раздел_ЗПР_СЕТИ_ВО',
            'points_ngs': 'Le_2_6_3_2_Т_НГС_ЗПР_СЕТИ_ВО',
        },
        'НЭ': {
            'source': LAYER_ZPR_NE,
            'razdel': 'Le_2_2_4_1_Раздел_ЗПР_НЭ',
            'ngs': 'Le_2_2_4_2_НГС_ЗПР_НЭ',
            'points_razdel': 'Le_2_6_4_1_Т_Раздел_ЗПР_НЭ',
            'points_ngs': 'Le_2_6_4_2_Т_НГС_ЗПР_НЭ',
        },
    }

    # Конфигурация overlay слоёв
    # ВАЖНО: Порядок соответствует приоритету категорий в M_36!
    # НП -> ООПТ -> Лес -> остальные
    # name_field: поле в overlay-слое для извлечения названия
    # ЗК РФ ст. 11.9 п. 3: границы ЗУ не должны пересекать границы МО и НП
    OVERLAY_CONFIG = {
        'НП': {'layer': LAYER_SELECTION_NP, 'name_field': 'name'},
        'ООПТ': {'layer': LAYER_WFS_OOPT, 'name_field': 'name'},
        'МО': {'layer': LAYER_SELECTION_MO, 'name_field': 'name'},
        'Лес': {'layer': LAYER_EGRN_LES, 'name_field': 'name'},
        'Вода': {'layer': LAYER_SELECTION_VODA, 'name_field': 'name'},
    }
    ...
    def check_data_availability(self, zpr_type: str = 'standard') -> Dict[str, Any]:
        ...
        Returns:
            dict: {
                ...
                'invalid_zpr': List[Dict] - ЗПР с невалидной структурой
                'vri_errors': List[Dict] - ЗПР с пустыми/невалидными VRI
        ...
        result = {
            ...
            'vri_errors': [],   # ЗПР с пустыми/невалидными VRI
            'can_cut': False
        }
        ...
        from Daman_QGIS.managers import LayerSchemaValidator, VRIAssignmentManager
        schema_validator = LayerSchemaValidator(self.plugin_dir)
        vri_manager = VRIAssignmentManager(self.plugin_dir)
        ...
        for zpr_name, zpr_config in config.items():
            ...
            if layer is not None and layer.isValid() and layer.featureCount() > 0:
                ...
                vri_valid, vri_errors = vri_manager.validate_zpr_vri(layer)
                if not vri_valid:
                    result['vri_errors'].append({
                        'name': zpr_name,
                        'layer': zpr_config['source'],
                        'errors': vri_errors
                    })
                    for err in vri_errors:
                        log_warning(f"M_26: Слой {zpr_config['source']}: {err}")
                else:
                    # Структура и VRI валидны - добавляем в доступные
                    result['available_zpr'].append(zpr_name)

        # can_cut только если есть ЗУ, есть доступные ЗПР, и нет ошибок VRI
        result['can_cut'] = (
            result['has_zu'] and
            len(result['available_zpr']) > 0 and
            len(result['vri_errors']) == 0
        )
    ...
    def cut_zpr_rek(self, zpr_types: Optional[List[str]] = None) -> Dict[str, Any]:
        ...
        if not availability['can_cut']:
            log_info("M_26: Нет данных для нарезки ЗПР_РЕК")
            return {'error': 'Нет данных для нарезки'}
    ...
    def _perform_cutting(
        ...
        for zpr_type in zpr_types:
            ...
            cut_result = self._cutting_engine.process_zpr_type(
                ...
                crs=crs,
                kk_layer=kk_layer,
                # Автоматическая классификация ЗУ (Изм/Без_Меж)
                detect_no_change=True,
                izm_layer_name=zpr_config.get('izm'),
                bez_mezh_layer_name=zpr_config.get('bez_mezh')
            )
    ...
    def _init_submodules(self) -> bool:
        ...
        try:
            ...
            from .submodules.Msm_26_1_geometry_processor import Msm_26_1_GeometryProcessor
            from .submodules.Msm_26_2_attribute_mapper import Msm_26_2_AttributeMapper
            from .submodules.Msm_26_3_layer_creator import Msm_26_3_LayerCreator
            from .submodules.Msm_26_4_cutting_engine import Msm_26_4_CuttingEngine
    ...
    def _get_overlay_layers(self) -> Dict[str, Dict[str, Any]]:
        """Получить доступные overlay слои с метаданными

        Returns:
            Dict: {тип: {'layer': QgsVectorLayer, 'name_field': str}}
        """
        overlay_layers: Dict[str, Dict[str, Any]] = {}
        for overlay_type, config in self.OVERLAY_CONFIG.items():
            layer = self._get_layer_by_name(config['layer'])
            if layer is not None and layer.isValid() and layer.featureCount() > 0:
                overlay_layers[overlay_type] = {
                    'layer': layer,
                    'name_field': config['name_field']
                }
                log_info(f"M_26: Найден overlay слой {config['layer']} "
    ...
    def _add_result_layers(self, cut_result: Dict[str, Any]) -> None:
        ...
        # Полигональные слои (Раздел, НГС, Изм, Без_Меж)
        for layer_key in ['razdel_layer', 'ngs_layer', 'izm_layer', 'bez_mezh_layer']:
