...
class OksZuAnalysisManager:
    ...
    def auto_analyze(self) -> Dict[str, Any]:
        ...
        Логика:
        1. Проверяет наличие слоёв выборки (L_1_9_1, L_1_9_2)
    ...
    def check_data_availability(self) -> Dict[str, bool]:
        ...
        Returns:
            {
                'selection_zu': bool,        # Есть L_1_9_1 или Le_1_9_1_1
                'selection_oks': bool,       # Есть L_1_9_2
    ...
    def analyze_cutting_geometry(
        ...
        Args:
            ...
            oks_layer: Слой ОКС (если None - ищет L_1_9_2_Выборка_ОКС)
