...
class Msm_24_2_FieldMapper:
    ...
    ZU_FIELD_MAPPINGS = {
        ...
        # Транзитная форма собственности (§5.2): форма выписки замещает форму НСПД
        # на слое выборки -> переносит дискриминатор ветки к классификатору Msm_25_2.
        # replace (доминирование выписки). Транзитность (не-экспорт) на синк не влияет
        # -- он работает по GPKG-колонкам независимо от export-наборов.
        '__Форма_тех': ('__Форма_тех', 'replace'),
    }
