...
Логика обновления:
    - Слой ОКС (L_1_9_2): заполняет ОКС_на_ЗУ_выписка и ОКС_на_ЗУ_факт
    - Слой ЗУ (Le_1_9_1_1): заполняет те же поля, но с обратным маппингом
...
class RelationMapper:
    ...
    def update_selection_layers(
        ...
        Args:
            oks_layer: Слой ОКС (L_1_9_2_Выборка_ОКС)
            zu_layer: Слой ЗУ (Le_1_9_1_1_Выборка_ЗУ)
