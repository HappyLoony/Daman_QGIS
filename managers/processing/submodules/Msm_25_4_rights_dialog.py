...
class Msm_25_4_RightsDialog(BaseResponsiveDialog):
    ...
    def _create_buttons_layout(self) -> QHBoxLayout:
        ...
        skip_btn.setToolTip("Пропустить этот участок, он попадёт в слой 'L_1_11_6_Права_ЗУ_Свед_нет'")
        skip_btn.clicked.connect(self._on_skip)
        layout.addWidget(skip_btn)

        # Кнопка "Пропустить все"
        skip_all_btn = QPushButton("Пропустить все (Сведения нет)")
        skip_all_btn.setToolTip("Пропустить все оставшиеся участки, они попадут в слой 'L_1_11_6_Права_ЗУ_Свед_нет'")
