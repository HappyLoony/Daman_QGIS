...
class StringSanitizer:
    ...
    def sanitize_attribute_value(self, value: Any) -> Any:
        ...
        ВАЖНО: Группировка "Физическое лицо" -> "Множество физических лиц"
        выполняется ОТДЕЛЬНО через AttributeProcessor.simplify_rent_individuals(),
        так как требует синхронной обработки полей Обременения и Арендаторы.
