...
Определяет в какой слой L_1_10_* должен попасть объект
...
class Msm_25_1_CategoryClassifier:
    ...
    DEFAULT_LAYER = "L_1_10_8_КАТ_Не_установлена"
    ...
    def get_category_mapping(self) -> Dict[Optional[str], Tuple[str, str]]:
        ...
        Returns:
            Dict[category_name, (full_name, short_name)]:
                ...
                full_name: Полное имя слоя (L_1_10_1_КАТ_НП)
                short_name: Короткое имя (КАТ_НП)
        """
