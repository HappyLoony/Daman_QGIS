...
def is_empty(value: Any) -> bool:
    ...
    - "Сведения отсутствуют", "Категория не установлена" — неинформативные
      плейсхолдеры НСПД/финализации: для fill-семантики они пусты, иначе
      «незнание» НСПД блокировало бы знание выписки (П.4 2026-07-17,
      выравнивание с критерием удалённого supplement-канала)
    ...
    return str_value in (
        '', 'NULL', '-', '0', '0.0',
        'Сведения отсутствуют', 'Категория не установлена',
    )
