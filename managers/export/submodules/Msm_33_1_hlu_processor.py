...
Типы ЗПР (7 штук):
- L_2_4_1_ЗПР_ОКС - Зона планируемого размещения ОКС
- L_2_4_2_ЗПР_ПО - ЗПР линейного объекта (на период строительства)
- L_2_4_3_ЗПР_ВО - ЗПР линейного объекта (на период эксплуатации)
- L_2_5_1_ЗПР_РЕК_АД - ЗПР реконструкции автодорог
- L_2_5_2_ЗПР_СЕТИ_ПО - ЗПР реконструкции сетей (период строительства)
- L_2_5_3_ЗПР_СЕТИ_ВО - ЗПР реконструкции сетей (период эксплуатации)
- L_2_5_4_ЗПР_НЭ - ЗПР реконструкции наземных элементов
...
from Daman_QGIS.constants import LAYERS_ZPR_ALL
...
ZPR_FULL_NAMES = {
    "L_2_4_1_ЗПР_ОКС": "Зона планируемого размещения объектов капитального строительства",
    "L_2_4_2_ЗПР_ПО": "Зона планируемого размещения линейного объекта (на период строительства)",
    "L_2_4_3_ЗПР_ВО": "Зона планируемого размещения линейного объекта (на период эксплуатации)",
    "L_2_5_1_ЗПР_РЕК_АД": "Зона планируемого размещения линейных объектов транспортной инфраструктуры, подлежащих реконструкции",
    "L_2_5_2_ЗПР_СЕТИ_ПО": "Зона планируемого размещения линейных объектов (инженерных сетей), подлежащих реконструкции (период строительства)",
    "L_2_5_3_ЗПР_СЕТИ_ВО": "Зона планируемого размещения линейных объектов (инженерных сетей), подлежащих реконструкции (период эксплуатации)",
    "L_2_5_4_ЗПР_НЭ": "Зона планируемого размещения наземных элементов инженерных сетей, подлежащих реконструкции"
}
