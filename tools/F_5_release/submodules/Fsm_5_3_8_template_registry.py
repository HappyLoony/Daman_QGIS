...
# Поля фичи, из которых Fsm_5_3_1 строит шапку контура образуемого ЗУ.
# Соответствие Base_cutting (working_name -> full_name):
#   ID              -> «Условный номер образуемого/ изменяемого земельного участка»
#   Площадь_ОЗУ     -> «Площадь образуемого/ изменяемого земельного участка, кв. м»
#   КН              -> «Кадастровый номер исходного земельного участка»; для НГС
#                      Msm_26_5 пишет в это же поле номер кадастрового квартала
#   Состав_контуров -> условные номера объединяемых ЗУ (заполняется на 2 этапе F_2_4)
CONTOUR_TITLE_FIELDS = ['Площадь_ОЗУ', 'КН', 'Состав_контуров']
