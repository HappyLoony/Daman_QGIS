...
class Fsm_0_4_7_TopologyCheckDialog(BaseResponsiveDialog):
    """
    ...
    def _setup_ui(self):
        ...
        self.check_button.setToolTip("Этап 1: Обнаружение ошибок")
        ...
        self.fix_button.setToolTip("Этап 2: Автоматическое исправление (временно отключено)")
