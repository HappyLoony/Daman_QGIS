...
def cleanup_test_project():
    ...
    Marks project as "not dirty" so QGIS won't prompt to save on exit.
    """
    ...
    # КРИТИЧНО: Пометить проект как "не изменённый"
    # Без этого QGIS спросит о сохранении при закрытии
...
class TempProjectFixtures:
    ...
    def create_temp_project_dir(cls) -> str:
        ...
        """
        # Регистрация cleanup при первом использовании
        if not cls._atexit_registered:
            atexit.register(cls.cleanup_temp_dirs)
    ...
    def create_project_structure(
        ...
        paths = {
            ...
            "gpkg_path": os.path.join(project_dir, PROJECT_GPKG_NAME),
