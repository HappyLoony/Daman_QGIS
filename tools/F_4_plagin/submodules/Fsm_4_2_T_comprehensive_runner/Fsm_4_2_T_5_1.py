# -*- coding: utf-8 -*-
"""
Субмодуль Fsm_4_2_T_6_1 - Тест функции F_5_1_Векторные слои
Проверка экспорта векторных слоёв в TAB с MapInfo стилями
"""


class TestF61:
    """Тесты для функции F_5_1_VectorExport"""
    ...
    def run_all_tests(self):
        ...
        self.logger.section("ТЕСТ F_5_1: Экспорт векторных слоёв (TAB)")
    ...
    def test_01_init_module(self):
        ...
        self.logger.section("1. Инициализация F_5_1_VectorExport")

        try:
            from Daman_QGIS.tools.F_5_release.F_5_1_vector_export import F_5_1_VectorExport

            self.module = F_5_1_VectorExport(self.iface)
            self.logger.success("Модуль F_5_1_VectorExport загружен")
    ...
    def test_03_mapinfo_translator(self):
        ...
        self.logger.section("3. Проверка Fsm_5_1_1_MapInfoTranslator")

        try:
            from Daman_QGIS.tools.F_5_release.submodules.Fsm_5_1_1_mapinfo_translator import Fsm_5_1_1_MapInfoTranslator

            translator = Fsm_5_1_1_MapInfoTranslator()
            self.logger.success("Fsm_5_1_1_MapInfoTranslator загружен")
