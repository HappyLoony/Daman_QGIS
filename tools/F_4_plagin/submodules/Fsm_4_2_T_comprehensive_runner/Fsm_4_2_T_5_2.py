# -*- coding: utf-8 -*-
"""
Субмодуль Fsm_4_2_T_6_2 - Тест функции F_5_2_Подложки
...
class TestF62:
    """Тесты для функции F_5_2_BackgroundExport"""
    ...
    def run_all_tests(self):
        """Запуск всех тестов F_5_2"""
        self.logger.section("ТЕСТ F_5_2: Экспорт подложек (DXF)")
        ...
        try:
            ...
            self.logger.error(f"Критическая ошибка тестов F_5_2: {str(e)}")

        self.logger.summary()

    def test_01_init_module(self):
        """ТЕСТ 1: Инициализация модуля F_5_2"""
        self.logger.section("1. Инициализация F_5_2_BackgroundExport")

        try:
            from Daman_QGIS.tools.F_5_release.F_5_2_background_export import F_5_2_BackgroundExport

            self.module = F_5_2_BackgroundExport(self.iface)
            self.logger.success("Модуль F_5_2_BackgroundExport загружен")
