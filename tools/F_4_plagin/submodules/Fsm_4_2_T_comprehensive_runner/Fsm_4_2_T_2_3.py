# -*- coding: utf-8 -*-
"""
Субмодуль Fsm_4_2_T_3_3 - Тест функции F_2_3_Корректировка
Проверка пересчёта атрибутов и точек после ручного редактирования нарезки
"""


class TestF33:
    """Тесты для F_2_3_Correction (корректировка нарезки)"""
    ...
    def run_all_tests(self):
        ...
        self.logger.section("ТЕСТ F_2_3: Корректировка нарезки")
    ...
    def test_01_init_module(self):
        """ТЕСТ 1: Инициализация модуля F_2_3_Correction"""
        self.logger.section("1. Инициализация F_2_3_Correction")

        try:
            from Daman_QGIS.tools.F_2_cutting.F_2_3_correction import F_2_3_Correction

            self.module = F_2_3_Correction(self.iface)
            self.logger.success("Модуль F_2_3_Correction загружен")
