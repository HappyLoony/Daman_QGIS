# -*- coding: utf-8 -*-
"""
Субмодуль Fsm_4_2_T_pyright - Тест статической типизации (pyright/pylance)
...
ТРЕБОВАНИЯ:
- qgis-stubs (устанавливается через F_4_1)
...
class TestPyright:
    ...
    def _get_plugin_root(self) -> str:
        ...
        # Путь: Fsm_4_2_T_pyright.py -> Fsm_4_2_T_comprehensive_runner -> submodules -> F_4_plagin -> tools -> Daman_QGIS
    ...
    def test_01_check_qgis_stubs(self) -> None:
        ...
        try:
            ...
            try:
                ...
                self.logger.info("Установка: pip install qgis-stubs (или через F_4_1)")
        ...
        for cmd in pyright_commands:
            try:
                ...
                result = subprocess.run(
                    ...
                    text=True,
                    encoding='utf-8',
                    errors='replace',  # Корректная обработка не-UTF-8 вывода
