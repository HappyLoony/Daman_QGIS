# -*- coding: utf-8 -*-
"""
Субмодуль Fsm_4_2_T_3_1 - Тест функции F_2_1_Нарезка_ЗПР
...
Проверяет:
- Инициализацию модуля F_2_1_NarezkaZPR
...
class TestF31:
    ...
    def test_01_import_module(self):
        """ТЕСТ 1: Импорт основного модуля F_2_1"""
        self.logger.section("1. Импорт F_2_1_NarezkaZPR")
        try:
    ...
    def test_02_check_structure(self):
        ...
        self.logger.section("2. Структура класса F_2_1_NarezkaZPR")
    ...
    def test_04_check_cutting_manager(self):
        ...
        try:
            ...
            self.logger.success("registry.get('M_26'): импорт OK")

            # Проверка структуры CuttingManager
            from Daman_QGIS.managers import CuttingManager
