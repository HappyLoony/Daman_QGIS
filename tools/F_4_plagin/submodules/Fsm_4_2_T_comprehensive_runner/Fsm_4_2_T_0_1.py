# -*- coding: utf-8 -*-
"""
Субмодуль Fsm_4_2_T_0_1 - Тест функции F_0_1_Создание проекта
...
class TestF01:
    ...
    def test_05_verify_geopackage(self):
        ...
        try:
            ...
            self.logger.check(
                os.path.basename(gpkg_path) == PROJECT_GPKG_NAME,
                f"Имя файла '{PROJECT_GPKG_NAME}' соответствует стандарту",
