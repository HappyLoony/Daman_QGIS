# -*- coding: utf-8 -*-
"""
Тестовый модуль Fsm_4_2_T_1_2 - Диагностика F_1_2
...
class TestF12:
    ...
    def _test_basic_systems(self):
        ...
        log_info("Fsm_4_2_T_1_2: Тестовое сообщение в лог-файл")
    ...
    def _test_managers(self):
        ...
        try:
            ...
            gpkg_file_path = os.path.normpath(os.path.join(project_path, PROJECT_GPKG_NAME))
