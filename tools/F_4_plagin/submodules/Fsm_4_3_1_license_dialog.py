# -*- coding: utf-8 -*-
"""
Fsm_4_3_1_LicenseDialog - GUI диалог управления лицензией
...
class LicenseDialog(QDialog):
    ...
    def on_activate(self):
        ...
        try:
            ...
            if success:
                ...
                self.message_label.setStyleSheet("color: red;")
                log_error(f"Fsm_4_3_1: Ошибка активации: {message}")

        except Exception as e:
            self.message_label.setText(f"Ошибка: {e}")
            self.message_label.setStyleSheet("color: red;")
            log_error(f"Fsm_4_3_1: Исключение при активации: {e}")
    ...
    def on_deactivate(self):
        ...
        try:
            ...
            if success:
                ...
                self.refresh_status()
                log_info("Fsm_4_3_1: Лицензия деактивирована")
            else:
                QMessageBox.warning(
                    self,
                    "Ошибка",
            ...
            log_error(f"Fsm_4_3_1: Исключение при деактивации: {e}")
    ...
    def on_copy_hwid(self):
        ...
        if hwid:
            ...
            log_info("Fsm_4_3_1: Hardware ID скопирован в буфер обмена")
