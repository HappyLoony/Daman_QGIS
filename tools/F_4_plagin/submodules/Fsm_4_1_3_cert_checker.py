# -*- coding: utf-8 -*-
"""
Fsm_4_1_3_CertificateChecker - Проверка корневых сертификатов Минцифры РФ
...
class CertificateChecker:
    ...
    def check_certificates() -> Dict[str, Any]:
        ...
        # Логируем результат
        log_info(f"F_4_1: Проверка сертификатов - найдено: {cert_info['certificates_installed']}, "
